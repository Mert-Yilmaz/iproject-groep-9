...
<!--                <tr>-->
<!--                    <th>Bankrekening</th>-->
<!--                    <td>--><?//= $rownaw['bankrekening'] ?><!--</td>-->
<!--                </tr>-->
<!--                <tr>-->
<!--                    <th>Creditcard</th>-->
<!--                    <td>--><?//= $rownaw['creditcard'] ?><!--</td>-->
<!--                </tr>-->
<!---->
<!---->
<!--                --><?php //if ($rownaw['verkoper'] == 1) { ?>
<!--                    <tr>-->
<!--                        <th><a href="editBankgegevens.php=edit_account=--><?//= $rownaw['gebruikersnaam'] ?><!--">Wijzig bankgegevens</a></th>-->
<!--                    </tr>-->
<!--                --><?php //} ?>
            </table>
        <?php } ?>
